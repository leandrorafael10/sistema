...
public class ContratoMidiaBean implements Serializable {
    ...
    /*
     ...
     context.execute("PF('dialogInsereContrato').show()");
     } else {
    ...
    /*
     ...
     true, getContratoMidia().getIDcliente());
    ...
    public void onRowCancel(RowEditEvent event) {
        FacesMessage msg = new FacesMessage("Edição Cancelada", ((ContratoMidia) event.getObject()).getNContrato());
    ...
    public void cadastrarNovo(ActionEvent event) {
        if (getContratoMidia().getIDcliente().getIDPessoa().getContatosList() == null) {
            ...
            getContratoMidia().getIDcliente().getIDPessoa().getContatosList().add(formatatel(getTelefoneF(), getTelefoneCel(), getTelefoneR(),
                    getTelefoneC()));
        }
        getContratoMidiaRN().cadastrarNovo(getContratoMidia(), this.dataInicioParcelas, producao);
        limpar();
    ...
    public Contato formatatel(String fixo, String celular, String residencial,
            String comercial) {
    ...
    public void renovarContrato(ActionEvent event) {
        getContratoMidiaRN().salvar(getContratoMidia(), getContato(),
                null, null, false, getProducao(), true);
